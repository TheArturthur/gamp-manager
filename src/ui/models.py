...
class Targets(db.Model):
    ...
    Project_id = db.Column(
        db.Integer, db.ForeignKey("Projects.idProject"), nullable=False
    )
    Exporter_id = db.Column(
        db.Integer, db.ForeignKey("Exporters.idExporter"), nullable=False
    )
